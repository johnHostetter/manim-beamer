...
class TestRoughSets(unittest.TestCase):
    ...
    def test_frbs(self) -> None:
        ...
        train_vector = robjects.FloatVector([
            5.2, -8.1, 4.8, 8.8, -16.1, 4.1, 10.6, -7.8, 5.5, 10.4, -29.0,
        ...
        test_vector = robjects.FloatVector([
            10.5, -0.9, 5.8, -2.8, 8.5, -0.6, 13.8, -11.9, 9.8, -1.2, 11.0,
            -14.3, 4.2, -17.0, 6.9, -3.3, 13.2, -1.9
        ])
        ...
        expected_predictions = [
            4.99864192655538, 4.537781270315337, 4.815638970562045, 4.126365559523999,
            4.888854200137037, 4.099266450792342, 3.5497141412115636, 4.706904694862706,
            5.492127995281615
        ]
