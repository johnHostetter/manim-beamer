...
class TestRoughSets(unittest.TestCase):
    """
    Test the properties of rough sets.
    """
    ...
    def test_lower_approximation(self):
        """
        Test that the 'lower approximation' of a set is correctly calculated.
        ...
        assert self.knowledge_base.lower('R', set_x_1) == frozenset()
        assert self.knowledge_base.lower('R', set_x_2) == frozenset()
        assert self.knowledge_base.lower('R', set_x_1.union(set_x_2)) == frozenset(self.set_e_1)
        assert self.knowledge_base.lower('R', set_x_1).union(
            self.knowledge_base.lower('R', set_x_2)).issubset(
            self.knowledge_base.lower('R', set_x_1.union(set_x_2)))
    ...
    def test_upper_approximation(self):
        ...
        assert self.knowledge_base.upper('R', set_y_1.intersection(
            set_y_2)) == frozenset(self.set_e_3)
        assert self.knowledge_base.upper('R', set_y_1) == frozenset(
            self.set_e_1).union(self.set_e_2).union(self.set_e_3)
        assert self.knowledge_base.upper('R', set_y_2) == \
               frozenset(self.set_e_1).union(self.set_e_2).union(self.set_e_3).union(self.set_e_4)
        assert self.knowledge_base.upper('R', set_y_2) == self.universe
        assert self.knowledge_base.upper('R', set_y_1.intersection(set_y_2)).issubset(
            self.knowledge_base.upper('R', set_y_1).intersection(
                self.knowledge_base.upper('R', set_y_2)))
    ...
    def test_boundary(self):
        ...
        assert self.knowledge_base.boundary('R', set_x_1) == frozenset(
            self.set_e_1).union(self.set_e_2)
        assert self.knowledge_base.boundary('R', set_x_2) == frozenset(self.set_e_2)
        assert self.knowledge_base.boundary('R', set_x_3) == frozenset(self.set_e_1)
    ...
    def test_negative(self):
        ...
        assert self.knowledge_base.negative('R', set_x_1) == frozenset({'x3', 'x6'})
        assert self.knowledge_base.negative('R', set_x_2) == frozenset(
            self.set_e_1).union(self.set_e_4)
        assert self.knowledge_base.negative('R', set_x_3) == frozenset(self.set_e_2)
    ...
    def test_accuracy(self):
        ...
        assert self.knowledge_base.accuracy('R', set_x_1) == 0.
...
class TestApproximationOfClassifications(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.knowledge_base.add_parent_relation('R', (self.set_x_1, self.set_x_2, self.set_x_3))
    ...
    def test_classifications_1(self):
        ...
        assert self.knowledge_base.lower('R', set_y_1) == frozenset(self.set_x_2)
        assert self.knowledge_base.upper('R', set_y_2) == frozenset(
            self.set_x_1).union(self.set_x_3) != self.universe
        assert self.knowledge_base.upper('R', set_y_3) == frozenset(self.set_x_3) != self.universe
    ...
    def test_classifications_2(self):
        ...
        assert self.knowledge_base.upper('R', set_z_1) == frozenset(
            self.set_x_1).union(self.set_x_2).union(self.set_x_3) == self.universe
        assert self.knowledge_base.lower('R', set_z_2) == frozenset()
        assert self.knowledge_base.lower('R', set_z_3) == frozenset()
