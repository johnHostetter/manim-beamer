...
class TestReductionOfKnowledge(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self.kb.add('P', {frozenset({'x1', 'x4', 'x5'}), frozenset({'x2', 'x8'}),
                          frozenset({'x3'}), frozenset({'x6', 'x7'})})
        self.kb.add('Q', {frozenset({'x1', 'x3', 'x5'}), frozenset({'x6'}),
                          frozenset({'x2', 'x4', 'x7', 'x8'})})
        self.kb.add('R', {frozenset({'x1', 'x5'}), frozenset({'x6'}),
...
class TestRelativeReductAndRelativeCore(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.kb = KnowledgeBase(self.universe)
        self.kb.add('P', {frozenset({'x1', 'x3', 'x4', 'x5', 'x6', 'x7'}), frozenset({'x2', 'x8'})})
        self.kb.add('Q', {frozenset({'x1', 'x3', 'x4', 'x5'}), frozenset({'x2', 'x6', 'x7', 'x8'})})
        self.kb.add('R', {frozenset({'x1', 'x5', 'x6'}), frozenset({'x2', 'x7', 'x8'}), frozenset({'x3', 'x4'})})
        self.kb.add('S', {
...
class TestReductionOfCategories(unittest.TestCase):
    ...
    def test_family_intersection(self):
        self.kb.add('X', {frozenset({'x1', 'x3', 'x8'})})
        self.kb.add('Y', {frozenset({'x1', 'x3', 'x4', 'x5', 'x6'})})
        self.kb.add('Z', {frozenset({'x1', 'x3', 'x4', 'x6', 'x7'})})
    ...
    def test_family_union(self):
        self.kb.add('X', {frozenset({'x1', 'x3', 'x8'})})
        self.kb.add('Y', {frozenset({'x1', 'x2', 'x4', 'x5', 'x6'})})
        self.kb.add('Z', {frozenset({'x1', 'x3', 'x4', 'x6', 'x7'})})
        self.kb.add('T', {frozenset({'x1', 'x2', 'x5', 'x7'})})
        # intersection of the family of sets
    ...
    def test_dependent(self):
        ...
        self.kb.add('Y', {frozenset({'x1', 'x3', 'x4', 'x5', 'x6'})})
        self.kb.add('Z', {frozenset({'x1', 'x3', 'x4', 'x6', 'x7'})})
        self.kb.add('F', {frozenset({'x1', 'x3', 'x8'}), frozenset({'x1', 'x3', 'x4', 'x5', 'x6'}),
    ...
    def test_T_indispensable(self):
        ...
        self.kb.add('Y', {frozenset({'x1', 'x3', 'x4', 'x5', 'x6'})})
        self.kb.add('Z', {frozenset({'x1', 'x3', 'x4', 'x6', 'x7'})})
        self.kb.add('T', {frozenset({'x1', 'x3', 'x8'})})
        F = {'X', 'Y', 'Z'}
