...
class TestDependenciesInKnowledgeBase(unittest.TestCase):
    ...
    def test_partial_depends_on(self):
        ...
        knowledge_base.add_parent_relation('Q', (
            set_x_1, set_x_2, set_x_3, set_x_4, set_x_5))
        knowledge_base.add_parent_relation('P', (
            set_y_1, set_y_2, set_y_3, set_y_4, set_y_5, set_y_6))

        assert knowledge_base.lower('P', set_x_1) == frozenset()
        assert knowledge_base.lower('P', set_x_2) == set_y_6
        assert knowledge_base.lower('P', set_x_3) == set_y_3.union(set_y_5)
